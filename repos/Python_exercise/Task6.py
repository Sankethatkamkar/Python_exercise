...
if __name__=='__main__':
    ...
    instances=["instance1", "instance2", "instance3", "instance4", "instance5"]
    for i in range(len(instances)):
        if i==0: instances[i] = Boeing_747(51,18,1,6)
        if i==1: instances[i] = Boeing_747(18,12,19,8)
        if i==2: instances[i] = Boeing_747(33,82,47,42)
        if i==3: instances[i] = Boeing_747(10,45,61,45)
        if i==4: instances[i] = Boeing_747(14,25,25,15)
