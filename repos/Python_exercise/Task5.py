...
if __name__=='__main__':
    ...
    instances=["instance1", "instance2", "instance3", "instance4", "instance5"]
    for i in range(len(instances)):
        if i==0: instances[i] = Boeing_747(12,14,25,50)
        if i==1: instances[i] = Boeing_747(17,12,78,56)
        if i==2: instances[i] = Boeing_747(10,14,16,26)
        if i==3: instances[i] = Boeing_747(50,12,84,10)
        if i==4: instances[i] = Boeing_747(17,29,29,25)
